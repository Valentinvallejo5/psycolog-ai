...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen w-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#C9A6FF]/40 via-[#B39DDB]/50 to-black" />
      ...
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[120vh] h-[60vh] rounded-b-[50%] bg-[#C9A6FF]/20 blur-[80px]" />
      <motion.div 
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[100vh] h-[60vh] rounded-b-full bg-[#B39DDB]/20 blur-[60px]"
        animate={{ 
      ...
      />
      <motion.div 
        className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-[90vh] h-[90vh] rounded-t-full bg-[#C9A6FF]/20 blur-[60px]"
        animate={{ 
          opacity: [0.3, 0.5, 0.3],
          scale: [1, 1.1, 1]
        }}
          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  {isLogin ? t('auth_welcome') : 'Únete a psicolog.ia'}
                </motion.h1>
