...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#4A1E5C] to-[#9B6BB8]",
    inner: "bg-gradient-to-b from-[#F3E8FF] via-[#6B21A8] to-[#E9D5FF]",
    button: "bg-gradient-to-b from-[#C9A6FF] to-[#9B6BB8]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(75_33_138_/_100%)]",
  },
  success: {
